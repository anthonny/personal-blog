...
self.addEventListener('activate', (e) => {
    ...
    console.log('[Workerify SW] Will start intercepting requests for scope:', self.registration.scope);
...
console.log('[Workerify SW] Service worker state:', self.registration?.active?.state);
